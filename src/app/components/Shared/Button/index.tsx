...
const mildRoundedShadow: className =
...
const outline: className =
  "gap-1 items-center border-solid	normal-case px-2 sm:px-3 md:px-4 py-2 rounded-4 border disabled:opacity-100 disabled:cursor-not-allowed";
